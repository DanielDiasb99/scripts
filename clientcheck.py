"""
this script can detect client.
detect openspade or normal client is important.
modified and added a component of antihacktools(AHT) by yuyasato

based on detectclient.py ( Author: noway421  License: CC-BY-SA)
"""
...
def aht_client_send(self):
	if chr(self.client_info.client) == 'o':
		return False #openspade
	else:
		return True #normal client
				...
				if not self.completed_version_challenge:
					...
					if packet_id == HandShakeReturn.id:
						...
						try:
							...
							if k!=34 and k!=32:
								print "!!!! error catch code: C1  in aht_cc loader_received !!!!"
								traceback.print_exc()
							else:
								pass
						...
						try:
							...
							if k!=34 and k!=32:
								print "!!!! error catch code: C2  in aht_cc loader_received !!!!"
								traceback.print_exc()
							else:
								pass
			try:
				...
				if k!=34 and k!=32:
					print "!!!! error catch code: C3  in aht_cc loader_received !!!!"
					traceback.print_exc()
				else:
					pass
